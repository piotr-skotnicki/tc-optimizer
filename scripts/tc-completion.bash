#!/bin/bash
complete -f -W "--strip-tiling --rectangular-tiling --correction-tiling --inv-correction-tiling --diamond-tiling --semi-diamond-tiling --merge-tiling --split-tiling --scc-correction-tiling \
                ...
                -b -R --report --cache -d --debug --align -D --version -v --help -h --inline --noinline --time --use-macros \
                -y --yes \
                -g --out -o \
                -m --max \
                --drop-bounds" \
