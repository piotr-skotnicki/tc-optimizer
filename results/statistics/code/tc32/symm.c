...
/* ./tc ../examples/polybench/symm.scop.c --correction-tiling --lex-scheduling --serial-codegen -b 32 --debug */
#define min(x,y)    ((x) < (y) ? (x) : (y))
#define max(x,y)    ((x) > (y) ? (x) : (y))
#define floord(n,d) (((n)<0) ? -((-(n)+(d)-1)/(d)) : (n)/(d))
#pragma scop
for (int ii0 = 0; ii0 <= floord(_PB_M - 1, 32); ii0 += 1) {
      ...
      if (ii2 == 2) {
        if (_PB_N >= 32 * ii1 + 33) {
          for (int i1 = 32 * ii1; i1 <= 32 * ii1 + 31; i1 += 1) {
            if (i1 >= 32 * ii1 + 1) {
              temp2 = 0;
              for (int i3 = 0; i3 < 32 * ii0; i3 += 1) {
                temp2 += (B[i3][i1] * A[32 * ii0][i3]);
              }
            }
            C[32 * ii0][i1] = (((beta * C[32 * ii0][i1]) + ((alpha * B[32 * ii0][i1]) * A[32 * ii0][32 * ii0])) + (alpha * temp2));
          }
        } else {
          for (int i1 = 32 * ii1; i1 < _PB_N; i1 += 1) {
            if (i1 >= 32 * ii1 + 1) {
              temp2 = 0;
              for (int i3 = 0; i3 < 32 * ii0; i3 += 1) {
                temp2 += (B[i3][i1] * A[32 * ii0][i3]);
        ...
        for (int i0 = 32 * ii0 + 1; i0 <= min(_PB_M - 1, 32 * ii0 + 31); i0 += 1) {
          if (32 * ii1 + 32 >= _PB_N) {
            for (int i1 = 0; i1 < 32 * ii1; i1 += 1) {
              temp2 = 0;
          ...
          for (int i1 = 32 * ii1; i1 <= min(_PB_N - 1, 32 * ii1 + 31); i1 += 1) {
            if (32 * ii1 + 32 >= _PB_N) {
              temp2 = 0;
            }
            if (_PB_N >= 32 * ii1 + 33) {
              C[32 * ii0][i1] += ((alpha * B[i0][i1]) * A[i0][32 * ii0]);
            } else {
              for (int i3 = 0; i3 < i0; i3 += 1) {
                if (i3 >= 32 * ii0) {
                  C[i3][i1] += ((alpha * B[i0][i1]) * A[i0][i3]);
        ...
        for (int ii3 = 0; ii3 < ii0; ii3 += 1) {
          for (int i0 = 32 * ii0; i0 <= min(_PB_M - 1, 32 * ii0 + 31); i0 += 1) {
            for (int i1 = 32 * ii1; i1 <= min(_PB_N - 1, 32 * ii1 + 31); i1 += 1) {
