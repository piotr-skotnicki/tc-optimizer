...
/* ./tc ../examples/polybench/cholesky.scop.c --correction-tiling --lex-scheduling --serial-codegen -b 32 --debug --iterative-tc */
#define min(x,y)    ((x) < (y) ? (x) : (y))
#define max(x,y)    ((x) > (y) ? (x) : (y))
#define floord(n,d) (((n)<0) ? -((-(n)+(d)-1)/(d)) : (n)/(d))
#pragma scop
for (int ii0 = 0; ii0 <= floord(_PB_N - 1, 32); ii0 += 1) {
  for (int ii2 = 0; ii2 <= min(ii0, (_PB_N - ii0 - 1) / 31 - 1); ii2 += 1) {
    for (int ii3 = max(0, -ii2 + 1); ii3 <= min(1, ii0 - ii2); ii3 += 1) {
      if (ii3 == 1) {
        ...
        for (int ii4 = 0; ii4 < ii2; ii4 += 1) {
          if (_PB_N >= 32 * ii0 + 32) {
            for (int i0 = max(32 * ii0, 32 * ii2 + 1); i0 <= 32 * ii0 + 31; i0 += 1) {
  ...
  for (int ii1 = max(1, -ii0 + 2); ii1 <= 2; ii1 += 1) {
    if (ii1 == 2) {
      if (_PB_N >= 32 * ii0 + 32) {
        for (int i0 = max(32, 32 * ii0); i0 <= 32 * ii0 + 31; i0 += 1) {
          for (int i2 = 32 * ii0; i2 < i0; i2 += 1) {
            for (int i4 = 32 * ii0; i4 < i2; i4 += 1) {
              A[i0][i2] -= (A[i0][i4] * A[i2][i4]);
            }
            A[i0][i2] /= A[i2][i2];
          }
