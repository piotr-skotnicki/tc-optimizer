          ...
          for (t5=32*t2;t5<=min(_PB_N-1,32*t2+31);t5++) {
            for (t6=32*t3;t6<=(min(t5,32*t3+31))-7;t6+=8) {
              for (t7=32*t4;t7<=min(_PB_M-1,32*t4+31);t7++) {
                ...
                C[t5][(t6+1)] += A[(t6+1)][t7]*alpha*B[t5][t7] + B[(t6+1)][t7]*alpha*A[t5][t7];;
                C[t5][(t6+2)] += A[(t6+2)][t7]*alpha*B[t5][t7] + B[(t6+2)][t7]*alpha*A[t5][t7];;
                C[t5][(t6+3)] += A[(t6+3)][t7]*alpha*B[t5][t7] + B[(t6+3)][t7]*alpha*A[t5][t7];;
                C[t5][(t6+4)] += A[(t6+4)][t7]*alpha*B[t5][t7] + B[(t6+4)][t7]*alpha*A[t5][t7];;
                C[t5][(t6+5)] += A[(t6+5)][t7]*alpha*B[t5][t7] + B[(t6+5)][t7]*alpha*A[t5][t7];;
                C[t5][(t6+6)] += A[(t6+6)][t7]*alpha*B[t5][t7] + B[(t6+6)][t7]*alpha*A[t5][t7];;
                C[t5][(t6+7)] += A[(t6+7)][t7]*alpha*B[t5][t7] + B[(t6+7)][t7]*alpha*A[t5][t7];;
              }
            }
