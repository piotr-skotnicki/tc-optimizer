      ...
      for (t3=0;t3<=floord(_PB_M-2,32);t3++) {
        for (t4=t3;t4<=floord(_PB_M-1,32);t4++) {
          for (t5=32*t3;t5<=min(min(_PB_M-2,32*t3+31),32*t4+30);t5++) {
            for (t6=max(32*t4,t5+1);t6<=(min(_PB_M-1,32*t4+31))-7;t6+=8) {
              lbv=32*t2;
...
#pragma vector always
              for (t7=lbv;t7<=ubv;t7++) {
                ...
                B[t5][t7] += A[(t6+1)][t5] * B[(t6+1)][t7];;
                B[t5][t7] += A[(t6+2)][t5] * B[(t6+2)][t7];;
                B[t5][t7] += A[(t6+3)][t5] * B[(t6+3)][t7];;
                B[t5][t7] += A[(t6+4)][t5] * B[(t6+4)][t7];;
                B[t5][t7] += A[(t6+5)][t5] * B[(t6+5)][t7];;
                B[t5][t7] += A[(t6+6)][t5] * B[(t6+6)][t7];;
                B[t5][t7] += A[(t6+7)][t5] * B[(t6+7)][t7];;
              }
            }
            for (;t6<=min(_PB_M-1,32*t4+31);t6++) {
              lbv=32*t2;
              ubv=min(_PB_N-1,32*t2+31);
#pragma ivdep
#pragma vector always
...
#pragma omp parallel for private(lbv,ubv,t3,t4,t5,t6,t7)
  for (t2=lbp;t2<=ubp;t2++) {
    for (t3=0;t3<=floord(_PB_N-1,32);t3++) {
      for (t4=32*t2;t4<=(min(_PB_M-1,32*t2+31))-7;t4+=8) {
        lbv=32*t3;
...
#pragma vector always
        for (t5=lbv;t5<=ubv;t5++) {
          ...
          B[(t4+1)][t5] = alpha * B[(t4+1)][t5];;
          B[(t4+2)][t5] = alpha * B[(t4+2)][t5];;
          B[(t4+3)][t5] = alpha * B[(t4+3)][t5];;
          B[(t4+4)][t5] = alpha * B[(t4+4)][t5];;
          B[(t4+5)][t5] = alpha * B[(t4+5)][t5];;
          B[(t4+6)][t5] = alpha * B[(t4+6)][t5];;
          B[(t4+7)][t5] = alpha * B[(t4+7)][t5];;
        }
      }
      for (;t4<=min(_PB_M-1,32*t2+31);t4++) {
        lbv=32*t3;
        ubv=min(_PB_N-1,32*t3+31);
#pragma ivdep
#pragma vector always
