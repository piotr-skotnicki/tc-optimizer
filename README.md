...
**Solution:**
- Make sure you have followed the [Installation](#Installation) guide ant the build was successful.
...
**Meaning:**
The inter-tile relation is not lexicographically forward, therefore the resultant tiling scheme does not allow for lexicographic execution of tiles.
...
| 2 | Assertion (debug build only) |
| 3 | Internal error |
| 4 | Invalid parameter or parameter value is missing |
